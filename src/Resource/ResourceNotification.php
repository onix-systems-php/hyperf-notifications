...
#[OA\Schema(
    ...
    properties: [
        ...
        new OA\Property(property: 'deliveries', ref: '#/components/schemas/ResourceNotificationDelivery'),
...
class ResourceNotification extends AbstractResource
{
    ...
    public function toArray(): array
    {
        return [
            ...
            'deliveries' => ResourceNotificationDelivery::collection($this->resource->deliveries),
